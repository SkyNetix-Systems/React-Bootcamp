// Import application configuration (JWT secret, AWS SES, client URL, etc.)
import * as config from "../config.js";

// JWT library for creating and verifying tokens
import jwt from "jsonwebtoken";

// Helper to generate reusable email templates
...
/**
 * Helper function
 * Generates access + refresh tokens and returns sanitized user
 */
...
/**
 * STEP 1: Pre-register user (send activation email)
 */
    ...
    config.AWSSES.sendEmail(
      emailTemplate(
        ...
        `
          ...
          <a href="${config.CLIENT_URL}/auth/account-activate/${token}">
            Activate my account
          </a>
        `,
        config.REPLY_TO,
...
/**
 * Access account after password reset
 */
...
export const agent = async (req, res) => {
  try {
    ...
    }).select("-password -role -enquiredProperties -wishlist");
