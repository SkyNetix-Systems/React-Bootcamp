...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    // DTO projection
    @Query("SELECT new com.skynetixetix.payload.DailySalesDTO(DATE(o.orderDate), " +
...
**Use DTO Projections:**
```java
@Query("SELECT new com.skynetixetix.payload.ProductPerformanceDTO(" +
