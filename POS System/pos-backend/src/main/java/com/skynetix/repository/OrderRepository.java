...
import com.skynetix.payload.StoreAnalysis.BranchSalesDTO;
import com.skynetix.payload.StoreAnalysis.PaymentInsightDTO;
import com.skynetix.payload.StoreAnalysis.TimeSeriesPointDTO;
...
""")
    ...
    @Query("""
    SELECT new com.skynetix.payload.StoreAnalysis.TimeSeriesPointDTO(
        o.createdAt,
        SUM(o.totalAmount)
    )
    FROM Order o
...
""")
    ...
    @Query("""
        SELECT new com.skynetix.payload.StoreAnalysis.PaymentInsightDTO(
            o.paymentType,
            SUM(o.totalAmount)
        )
        FROM Order o
    ...
    """)
        ...
        @Query("""
        SELECT new com.skynetix.payload.StoreAnalysis.BranchSalesDTO(
            o.branch.name,
            SUM(o.totalAmount)
        )
        FROM Order o
