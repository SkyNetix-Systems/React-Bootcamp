...
import com.skynetix.payload.StoreAnalysis.CategorySalesDTO;
...
// store analysis
    ...
    @Query("""
        SELECT new com.skynetix.payload.StoreAnalysis.CategorySalesDTO(
            p.category.name,
    ...
    @Query("""
        SELECT new com.skynetix.payload.dto.ProductDTO(
                p.id,
                p.name,
                p.sku,
                p.description,
